...
const normalizeReportRow = (row) => ({
  ...
  printerDeadline: getFirstValue(row, [
    "printerDeadline",
    "PrinterDeadline",
    "printerdeadline",
    "Printer Deadline",
  ]),
  deadline: getFirstValue(row, [
    "deadline",
    "Deadline",
    "jobDeadline",
    "JobDeadline",
  ...
  startdate: getFirstValue(row, [
    "startdate",
    "startDate",
    "StartDate",
    "printingStartDate",
    "PrintingStartDate",
    "printingStartTimestampUtc",
    "PrintingStartTimestampUtc",
    "Job Start Date",
  ]),
  enddate: getFirstValue(row, [
    "enddate",
    "endDate",
    "EndDate",
    "printingEndDate",
    "PrintingEndDate",
    "printingEndTimestampUtc",
    "PrintingEndTimestampUtc",
    "Job End Date",
  ]),
});
