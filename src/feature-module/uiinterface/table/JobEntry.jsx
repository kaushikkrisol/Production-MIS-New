  ...
  />
        ...
        {activeJobEntryTab === "existing" && (
          <>
            ...
            <div className="job-entry-radio-group" style={{ display: "flex", gap: "18px", alignItems: "center", margin: "12px 0", fontWeight: 700 }}>
                  ...
                  <table className="job-lines-table estimate-lines-table">
                    ...
                    <tbody>
                      {lines.length ? lines.map((line, index) => {
                        ...
                        <tr>
                          <td colSpan={17} style={{ textAlign: "center", padding: "18px 12px", color: "#6b7280" }}>
